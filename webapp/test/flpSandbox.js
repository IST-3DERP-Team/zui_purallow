					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Purchasing Allowance",
									"targetURL": "#zuipurallow-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zuipurallow-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zuipurallow",
									"url": sap.ui.require.toUrl("zuipurallow")
								}
							}
						}
					}
